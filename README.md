...
- `lab1/` - Python notebooks for initial exercises including hello-world and tidyfinance tutorials
- `lab2/` - Advanced Python notebooks continuing the tidyfinance series
- `resources/` - Additional resource files for the labs

You can ignore any files and folders beginning with a dot (.) and Python project configuration files.
